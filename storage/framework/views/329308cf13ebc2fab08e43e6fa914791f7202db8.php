...
<head>
  ...
  <title>TRACKSERIES|User View Profile</title>
</head>
<style>
  ...
  <div class="sidenav">
    ...
    <div class="main">
        <div style="display: inline-block;margin-top:10px">
                ...
                <img id="output" src="<?php echo e(asset('upload')); ?>/<?php echo e($userinfo->picture); ?>" alt="PROFILE PICTURE" width="200" height="200"><br>
                <h3 style='color: white'><?php echo e($userinfo->fname); ?> <?php echo e($userinfo->lname); ?></h3><br>
                <h3 style='color: white'>First Name: <?php echo e($userinfo->fname); ?></h3>
                <h3 style='color: white'>Surname: <?php echo e($userinfo->lname); ?></h3>
                <h3 style='color: white'>Mail ID: <?php echo e($userinfo->mail); ?></h3>
                <h3 style='color: white'>Gender: <?php echo e($userinfo->gender); ?></h3>
                <h3 style='color: white'>Birth Date: <?php echo e($userinfo->dob); ?></h3>
                <h3 style='color: white'>Region: <?php echo e($userinfo->country); ?></h3>
...
<?php /* F:\Spring 18-19\ATP 3\FINAL\Project\Dipto\Project V 29.4.19\resources\views/user/viewprofile.blade.php */ ?>