...
<body>
  ...
  <div class="main">
          ...
          <h4 style='text-align:center;color:white'>MY POSTED REVIEWS</h4>
        ...
        <table class="table table-dark table-striped table-borderless table-hover table-sm">
          ...
          <?php if($data): ?>
            ...
            <tr>
                ...
                <td><a href='<?php echo e(route('tsrm.msprof',['id' => $data[$a]->ms_id])); ?>'><?php echo e($data[$a]->ms_name); ?></a></td>
                
                <?php if($data[$a]->mstype == 1): ?>
                 <td><?php echo e('MOVIE'); ?></td>
                <?php else: ?>
                  <td><?php echo e('SERIES'); ?></td>
                <?php endif; ?>

                <td><?php echo e($data[$a]->rating); ?></td>
                <td><?php echo e($data[$a]->comment); ?></td>
                <td><?php echo e($data[$a]->date); ?></td> 
                <td><a href="<?php echo e(route('user.deletereviews',['id' => $data[$a]->review_id])); ?>" class="badge badge-danger">DELETE</a></td>
              </tr>
<?php endfor; ?>
<?php endif; ?>
        </table>
...
<?php /* F:\Spring 18-19\ATP 3\FINAL\Project\Dipto\Project V 29.4.19\resources\views/user/reviews.blade.php */ ?>