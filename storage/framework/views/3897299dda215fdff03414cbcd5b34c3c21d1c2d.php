        ...
        <table class="table table-dark table-striped table-borderless table-hover table-sm">
          ...
          <?php if($data): ?>
            ...
            <tr>
                ...
                <td ><a href="<?php echo e(route('user.unfollowseries',['id' => $data[$a]->ms_id])); ?>" class="badge badge-secondary">UNFOLLOW</a></td>
              </tr>
<?php endfor; ?>
<?php endif; ?>
        </table>
...
<?php /* F:\Spring 18-19\ATP 3\FINAL\Project\Dipto\Project V 29.4.19\resources\views/user/serieslist.blade.php */ ?>