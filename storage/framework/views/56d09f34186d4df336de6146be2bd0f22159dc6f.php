...
<body>
  ...
  <div class="sidenav">
      <a href="<?php echo e(route('user.track')); ?>"><i class="fas fa-thumbtack fa-sm"></i> Track</a>
      <a href="<?php echo e(route('user.reviews')); ?>"><i class="fas fa-star-half-alt fa-sm"></i> Reviews</a>
      <a href="<?php echo e(route('user.follower')); ?>"><i class="far fa-hand-point-right fa-sm"></i> Follower</a>
      <a href="<?php echo e(route('user.following')); ?>"><i class="far fa-hand-point-left fa-sm"></i> Following</a>
      <a href="<?php echo e(route('user.followedmovie')); ?>"><i class="fas fa-film"></i> Movies</a>
      <a href="<?php echo e(route('user.followedseries')); ?>"><i class="fas fa-video fa-sm"></i> Series</a>  
    </div>
  ...
  <div class="main">
          ...
          <?php if($alldata): ?>
          <h4 style='text-align:center;color:white'>RECENT REVIEWS</h4>
              <?php for($p = 0;$p<count($alldata);$p++): ?>
              <div class="media border p-1">
                  <img src="<?php echo e(asset('upload')); ?>/<?php echo e($alldata[$p]->picture); ?>" alt="IMAGE" class="mr-3 mt-3 rounded-circle" style="width:60px;">
                  <div class="media-body" style='margin:1px'>
                    <h4 style='color:white'><a href='<?php echo e(route('tsrm.userprof',['id' => $alldata[$p]->user_id])); ?>'><?php echo e($alldata[$p]->fname); ?> <?php echo e($alldata[$p]->lname); ?> </a><small><i>Reviewed <a href='<?php echo e(route('tsrm.msprof',['id' => $alldata[$p]->ms_id])); ?>'><?php echo e($alldata[$p]->ms_name); ?></a> on <?php echo e($alldata[$p]->date); ?></i></small></h4>
                    <?php if($alldata[$p]->rating): ?>
                    <p style='color:white;font-size:20px'>Rated:<?php echo e($alldata[$p]->rating); ?> Star!</p>
                    <?php endif; ?>
                    <?php if($alldata[$p]->comment): ?>
                    <p style='color:white;font-size:15px'><?php echo e($alldata[$p]->comment); ?></p>
                    <?php endif; ?>      
                  </div>
                </div>       
                <?php endfor; ?>
          <?php else: ?>
              <?php echo e('Please Follow People To See Their Reviews'); ?>
...
<?php /* F:\Spring 18-19\ATP 3\FINAL\Project\Dipto\Project V 29.4.19\resources\views/user/home.blade.php */ ?>