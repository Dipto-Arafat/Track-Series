...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost:8000/tsrm/user/home"><i class="fas fa-home"></i>Home</a>
                </li>
            </ul>
        </div>
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/tsrm/logout"><i class="fas fa-sign-out-alt"></i>Log Out</a>
            </li>
        </ul>
    ...
    <div class="msdashboard">
        <fieldset style='margin-left:10px;margin-top:10px;margin-right:10px;margin-bottom: 10px'>
            <img alt='USER PROFILE PICTURE' class='followerimage' src='<?php echo e(asset('upload')); ?>/<?php echo e($userinfo->picture); ?>'
                    width='500px'
                    height='250px' style='display: block'>
                    <br>
                    <h3><?php echo e($userinfo->fname); ?> <?php echo e($userinfo->lname); ?><h3>
                        <?php if(Session::get('xuser')->user_id == $userinfo->user_id): ?>

                        <?php elseif($followflag == false): ?>
                        <input type='button' class='signbutton' id='<?php echo e($userinfo->user_id); ?>' value='FOLLOW'
                            onclick='followuser(this)'>
                        <?php else: ?>
                        <input type='button' class='signbutton' id='<?php echo e($userinfo->user_id); ?>' value='UNFOLLOW'
                ...
                <h4 style='font-weight:bold;font-family:cursive'>DETAILS<h4>
                        <table class="user_table" height="400" width="500" align="center">
                            <tr>
                                ...
                                <td><b class="table_data"><?php echo e($userinfo->fname); ?></b></td>
                            </tr>
                            <tr>
                                <td><b class="table_data">SURNAME</b></td>
                                <td><b class="table_data"><?php echo e($userinfo->lname); ?></b></td>
                            </tr>
                            <tr>
                                <td><b class="table_data">Mail ID</b></td>
                                <td><b class="table_data"><?php echo e($userinfo->mail); ?></b></td>
                            </tr>
                            <tr>
                                <td><b class="table_data">GENDER</b></td>
                                <td><b class="table_data"><?php echo e($userinfo->gender); ?></b></td>
                            </tr>
                            <tr>
                                <td><b class="table_data">DOB</b></td>
                                <td><b class="table_data"><?php echo e($userinfo->dob); ?></b></td>
                            </tr>
                            <tr>
                                <td><b class="table_data">COUNTRY</b></td>
                                <td><b class="table_data"><?php echo e($userinfo->country); ?></b></td>
                            </tr>
                        </table>
            </fieldset>

            <fieldset id='sectiontwo' style='margin-left:30px;margin-right:30px;margin-top:20px;margin-bottom:20px;text-align:center'>
                    <h4 style='font-weight:bold;font-family:cursive'>REVIEWS(<?php echo e(count($userreview)); ?>)</h4>
                    <hr>
                    <fieldset>
                        <table class='signup_table' height='400' width='500' align='center'>
    
                            <?php for($k=0;$k<count($userreview);$k++): ?>
                            <tr>
                                <td style='text-align:left'><a href="/tsrm/msprof/<?php echo e($userreview[$k]->ms_id); ?>">
                                        <?php echo e($userreview[$k]->ms_name); ?></a><br>
                                    <?php for($ii = 1;$ii <= 5;$ii++): ?>
                            <?php if($ii <= $userreview[$k]->rating): ?>
                            ...
                            <?php endif; ?>
                            <?php endfor; ?>
                                    <h4>Review Date:<?php echo e($userreview[$k]->date); ?></h4>
                                    <p><?php echo e($userreview[$k]->comment); ?></p>
                                    <hr width='100%'>
                                </td>
                            </tr>
                            <?php endfor; ?>
...
<?php /* F:\Spring 18-19\ATP 3\FINAL\Project V 27.4.19 - Copy\resources\views/userprofile/userprof.blade.php */ ?>