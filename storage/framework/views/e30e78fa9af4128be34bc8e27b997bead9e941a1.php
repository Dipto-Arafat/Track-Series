...
<body>
  ...
  <div class="main">
          ...
          <h4 style='text-align:center;color:white'>MOVIE LIST</h4>
        ...
        <table class="table table-dark table-striped table-borderless table-hover table-sm">
          ...
          <?php if($data): ?>
            ...
            <tr>
                ...
                <td ><?php echo e($data[$a]->ms_release_date); ?></td>
                <td ><a href="<?php echo e(route('user.unfollowmovie',['id' => $data[$a]->ms_id])); ?>" class="badge badge-secondary">UNFOLLOW</a></td>
              </tr>
<?php endfor; ?>
<?php endif; ?>
        </table>
...
<?php /* F:\Spring 18-19\ATP 3\FINAL\Project\Dipto\Project V 29.4.19\resources\views/user/movielist.blade.php */ ?>