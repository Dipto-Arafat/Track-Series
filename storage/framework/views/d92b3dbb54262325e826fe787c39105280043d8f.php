...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/bookstore/logout"><i class="fas fa-sign-out-alt"></i>Log Out</a>
      </li>
    </ul>
...
*/
          if(response.rflag == '1'){
            ...
            $(".resultdiv").append("<a href='/bookstore/book_prof/" + data.fname + "'>" + data.lname + "</a><br>");
            
          });

          $(".resultdiv").append("<h6>MOVIE SERIES</h6>");
          response.msdata.forEach(function (data) {
            $(".resultdiv").append("<a href='/bookstore/book_prof/" + data.ms_name + "'>" + data.ms_name + "</a><br>");
...
<?php /* F:\Spring 18-19\ATP 3\FINAL\Project V 2.4.19\resources\views/user/home.blade.php */ ?>