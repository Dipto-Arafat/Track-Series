...
<body>
  ...
  <div class="main">
          ...
          <h4 style='text-align:center;color:white'>FOLLOWING LIST</h4>
        ...
        <table class="table table-dark table-striped table-borderless table-hover table-sm">
          ...
          <?php if($data): ?>
            ...
            <tr>
                <td > <img src="<?php echo e(asset('upload')); ?>/<?php echo e($data[$a]->picture); ?>" alt="IMAGE" class="mr-3 mt-3 rounded-circle" style="width:60px;"></td>
                <td ><a href='<?php echo e(route('tsrm.userprof',['id' => $data[$a]->user_id])); ?>'><?php echo e($data[$a]->fname); ?> <?php echo e($data[$a]->lname); ?></a></td>
                <td ><?php echo e($data[$a]->gender); ?></td>
                <td ><a href="<?php echo e(route('user.unfollowuser',['id' => $data[$a]->user_id])); ?>" class="badge badge-secondary">UNFOLLOW</a></td>
              </tr>
<?php endfor; ?>
<?php endif; ?>
        </table>
...
<?php /* F:\Spring 18-19\ATP 3\FINAL\Project\Dipto\Project V 29.4.19\resources\views/user/following.blade.php */ ?>