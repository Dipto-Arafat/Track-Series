	...
	<div class='box'>
		...
		<form method='post'>
			...
			<?php if(Session::has('msg')): ?>
				<input type="hidden" id="custId" name="custId" value="<?php echo e(Session::get('msg')); ?>">
			<?php endif; ?>
...
<?php /* F:\Spring 18-19\ATP 3\FINAL\Project\Dipto\Project V 29.4.19\resources\views/login/index.blade.php */ ?>