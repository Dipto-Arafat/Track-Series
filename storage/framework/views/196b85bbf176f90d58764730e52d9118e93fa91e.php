...
<body>
  ...
  <div class="main">
          ...
          <h4 style='text-align:center;color:white'>FOLLOWER LIST</h4>
        ...
        <table class="table table-dark table-striped table-borderless table-hover table-sm">
          ...
          <?php if($data): ?>
            ...
            <tr>
                ...
                <td ><?php echo e($data[$a]->dob); ?></td>
                <td ><?php echo e($data[$a]->country); ?></td>
              </tr>
<?php endfor; ?>
<?php endif; ?>
        </table>
...
<?php /* F:\Spring 18-19\ATP 3\FINAL\Project\Dipto\Project V 29.4.19\resources\views/user/follower.blade.php */ ?>