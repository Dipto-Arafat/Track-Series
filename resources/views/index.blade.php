        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                      <a style="border: 1px solid" class="nav-link mr-1" href="{{route('tsrm.login')}}"><i class="fas fa-sign-in-alt"></i>Log In</a>
                    </li>
                    <li class="nav-item">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="{{asset('upload')}}/first.jpg" alt="First slide">
                  ...
                  <div class="carousel-item">
                    <img class="d-block w-100" src="{{asset('upload')}}/second.jpg" alt="Second slide">
                    <div class="carousel-caption d-none d-md-block">
                  ...
                  <div class="carousel-item">
                    <img class="d-block w-100" src="{{asset('upload')}}/third.jpg" alt="Third slide">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="jumbotron jumbotron-fluid">
                  ...
                  <div class="container">
                                <button type="button" class="btn btn-primary btn-lg btn-block">
                                        USERS <br><span class="badge badge-light">{{$user}}</span>
                                        <span class="sr-only">unread messages</span>
                                </button>

                                <button type="button" class="btn btn-primary btn-lg btn-block">
                                        MOVIES <br><span class="badge badge-light">{{$movies}}</span>
                                        <span class="sr-only">unread messages</span>
                                </button>

                                <button type="button" class="btn btn-primary btn-lg btn-block">
                                        SERIES <br><span class="badge badge-light">{{$series}}</span>
                                        <span class="sr-only">unread messages</span>
                                </button>

                                <button type="button" class="btn btn-primary btn-lg btn-block">
                                        REVIEWS <br><span class="badge badge-light">{{$reviews}}</span>
                                        <span class="sr-only">unread messages</span>
                                </button>
