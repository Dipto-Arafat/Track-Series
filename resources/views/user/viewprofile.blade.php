  ...
  <div class="sidenav">
    ...
    <div class="main">
        <div style="display: inline-block;margin-top:10px">
                ...
                <img id="output" src="{{asset('upload')}}/{{$userinfo->picture}}" alt="PROFILE PICTURE" width="200" height="200"><br>
                <h3 style='color: white'>{{$userinfo->fname}} {{$userinfo->lname}}</h3><br>
                <h3 style='color: white'>First Name: {{$userinfo->fname}}</h3>
                <h3 style='color: white'>Surname: {{$userinfo->lname}}</h3>
                <h3 style='color: white'>Mail ID: {{$userinfo->mail}}</h3>
                <h3 style='color: white'>Gender: {{$userinfo->gender}}</h3>
                <h3 style='color: white'>Birth Date: {{$userinfo->dob}}</h3>
                <h3 style='color: white'>Region: {{$userinfo->country}}</h3>
