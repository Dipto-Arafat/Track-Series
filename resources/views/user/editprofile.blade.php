    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="{{route('user.viewprofile')}}">View Profile</a>
  ...
  <div class="sidenav">
    ...
    <div class="main">
        <div style="display: inline-block;margin-top:10px">
            ...
            <br>
            <img id="output" src="{{asset('upload')}}/{{$userinfo->picture}}" alt="PROFILE PICTURE" width="300" height="250"><br>
            ...
            <fieldset style='border: 1px solid black;padding: 10px'>
                <form style='padding:5px' method='post' action='/tsrm/user/editprofile'>
                    ...
                    <div class="form-row">
                        <div class="col-6">
                            <h3> FIRST NAME</h3>
                            <input type="text" class="form-control" placeholder="FIRST NAME" value='{{$userinfo->fname}}' name='fname'>
                        </div>
                        <div class="col-6">
                            <h3> SURNAME</h3>
                            <input type="text" class="form-control" placeholder="SURNAME" value='{{$userinfo->lname}}' name='lname'>
                        </div>
                    </div>
                    <h3> PASSWORD</h3>
                    <div class="form-row">
                        <div class="col-12">
                            <input type="password" class="form-control" placeholder="PASSWORD" name='pass' value='{{Session::get('xpass')}}'>
                        </div>
                    </div>
                    ...
                    <div class='form-row'>
                        <div class='col-4'>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="customRadioInline1" name="radio" class="custom-control-input" value='Male' @if($userinfo->gender == 'Male')
{{'checked'}} @endif
              >
                        ...
                        <div class='col-4'>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="customRadioInline2" name="radio" class="custom-control-input" value='Female' @if($userinfo->gender == 'Female')
                                    {{'checked'}}
                                    @endif            >
                        ...
                        <div class="col-4">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="customRadioInline3" name="radio" class="custom-control-input" value='Others' @if($userinfo->gender == 'Others')
                                    {{'checked'}}
                                    @endif    >
                    ...
                    <div class="form-row">
                        <div class="col-4">
                            <h3> DAY</h3>
                            @php $res = explode("/",$userinfo->dob); @endphp
                            <input type="text" class="form-control" placeholder="DAY" value='@if(count($res)>=3){{$res['0']}}@endif' name='day'>
                        </div>
                        <div class="col-4">
                            <h3> MONTH</h3>
                            <input type="text" class="form-control" placeholder="MONTH" value='@if(count($res)>=3){{$res['1']}}@endif' name='month'>
                        </div>
                        <div class="col-4">
                            <h3>YEAR</h3>
                            <input type="text" class="form-control" placeholder="YEAR" value='@if(count($res)>=3){{$res['2']}}@endif' name='year'>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="col-12">
                            <input type="text" class="form-control" placeholder="COUNTRY" value='{{$userinfo->country}}' name='country'>
                        </div>
                    </div>
                    <div class='form-row'>
                        <div class='col-12'>
